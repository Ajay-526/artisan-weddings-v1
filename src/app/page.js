...
export default function Home() {
  return (
    <>
      <section className="relative z-0 min-h-[100vh] isolate overflow-hidden text-white">
        <video
          src={heroImg}
          autoPlay
          muted
